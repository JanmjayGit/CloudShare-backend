package janmjay.example.cloudshare.security;
...
@Component
public class ClerkJsonWebKeyProvider {
    ...
    // method to convert the Json object present in JWKS url into Java objkect using mapper to read
